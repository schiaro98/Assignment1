...
\@pvspace{8.0pt}%
\@x{ NT \.{\defeq} 2}%
\@x{ FLAG \.{\defeq} 1 \.{\dotdot} NT}%
\@x{ WORDS \.{\defeq} 5}%
\@x{ TOT\_WORDS \.{\defeq} NT \.{*} WORDS}%
\@pvspace{8.0pt}%
\pcalsymbolstrue
\pcalshadingtrue
\csyntaxfalse
\@x{\@s{12.29} {\p@mmalgorithm} WordsCounter}%
\@pvspace{8.0pt}%
\@x{ {\p@variables} rankLock \.{=} 1 ,\, freq \.{=} 0 {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{ {\p@define}}%
\@x{\@s{16.4} FinalValue \.{\defeq} {\Diamond} ( freq \.{=} TOT\_WORDS )}%
 \@x{\@s{16.4} MutualExclusion \.{\defeq} {\Box} {\lnot} ( \A\, i \.{\in} FLAG
 \.{:} pc [ i ] \.{=}\@w{CS} )}%
\@y{\@s{0}%
 Se \ensuremath{NT \.{\leq} 2
}}%
\@xx{}%
\@x{ {\p@end} {\p@define} {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{ {\p@macro} acquire ( s ) {\p@begin}}%
\@x{\@s{8.2} {\p@await} s \.{=} 1 {\p@semicolon}}%
\@x{\@s{8.2} s \.{:=} 0 {\p@semicolon}}%
\@x{ {\p@end} {\p@macro} {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{ {\p@macro} release ( s ) {\p@begin}}%
\@x{\@s{8.2} s \.{:=} 1 {\p@semicolon}}%
\@x{ {\p@end} {\p@macro} {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{ {\p@macro} count ( wrd ,\, frq ) {\p@begin}}%
\@x{\@s{16.4} wrd \.{:=} wrd \.{-} 1 {\p@semicolon}}%
\@x{\@s{16.4} frq\@s{4.23} \.{:=} frq\@s{4.23} \.{+} 1 {\p@semicolon}}%
\@x{ {\p@end} {\p@macro} {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{ {\p@fair} {\p@process} mainCounting \.{\in} 1 \.{\dotdot} NT}%
\@x{ {\p@variables} words \.{=} WORDS {\p@semicolon}}%
\@x{ {\p@begin} MainLoop\@s{.5}\textrm{:}\@s{3}}%
\@x{\@s{39.34} {\p@while} words \.{\neq} 0 {\p@do}}%
 \@x{\@s{39.34} l2\@s{.5}\textrm{:}\@s{3}\@s{5.38} acquire ( rankLock )
 {\p@semicolon}}%
\@y{%
 \cdash{3} \ensuremath{Init} \ensuremath{CS}\cdash{3}
}%
\@xx{}%
 \@x{\@s{39.34} CS\@s{.5}\textrm{:}\@s{3} count ( words ,\, freq )
 {\p@semicolon}}%
 \@x{\@s{39.34} l6\@s{.5}\textrm{:}\@s{3}\@s{5.38} release ( rankLock )
 {\p@semicolon}}%
\@y{\@s{0}%
 \cdash{3} End \ensuremath{CS}\cdash{3}
}%
\@xx{}%
...
\@x{}%
\@y{\@s{0}%
 BEGIN TRANSLATION (\ensuremath{chksum(pcal) \.{=}} ``\ensuremath{34068bc6}''
 \ensuremath{\.{\land} chksum(tla) \.{=}} ``\ensuremath{1ef0faff}'')
}%
\@xx{}%
\@x{ {\VARIABLES} rankLock ,\, freq ,\, pc}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 define statement
...
\@xx{}%
\@x{ FinalValue \.{\defeq} {\Diamond} ( freq \.{=} TOT\_WORDS )}%
 \@x{ MutualExclusion \.{\defeq} {\Box} {\lnot} ( \A\, i \.{\in} FLAG \.{:} pc
 [ i ] \.{=}\@w{CS} )}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLE} words}%
\@pvspace{8.0pt}%
\@x{ vars \.{\defeq} {\langle} rankLock ,\, freq ,\, pc ,\, words {\rangle}}%
\@pvspace{8.0pt}%
\@x{ ProcSet \.{\defeq} ( 1 \.{\dotdot} NT )}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
\@y{\@s{0}%
 Global variables
...
\@xx{}%
\@x{\@s{35.70} \.{\land} rankLock \.{=} 1}%
\@x{\@s{35.70} \.{\land} freq \.{=} 0}%
\@x{\@s{35.70}}%
\@y{\@s{0}%
 Process \ensuremath{mainCounting
}}%
\@xx{}%
 \@x{\@s{35.70} \.{\land} words \.{=} [ self \.{\in} 1 \.{\dotdot} NT
 \.{\mapsto} WORDS ]}%
 \@x{\@s{35.70} \.{\land} pc \.{=} [ self \.{\in} ProcSet
 \.{\mapsto}\@w{MainLoop} ]}%
\@pvspace{8.0pt}%
\@x{ MainLoop ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{MainLoop}}%
\@x{\@s{87.07} \.{\land} {\IF} words [ self ] \.{\neq} 0}%
 \@x{\@s{110.34} \.{\THEN} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [
 self ] \.{=}\@w{l2} ]}%
 \@x{\@s{110.34} \.{\ELSE} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [
 self ] \.{=}\@w{Done} ]}%
 \@x{\@s{87.07} \.{\land} {\UNCHANGED} {\langle} rankLock ,\, freq ,\, words
 {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ l2 ( self )\@s{5.38} \.{\defeq} \.{\land} pc [ self ]\@s{7.92}
 \.{=}\@w{l2}}%
\@x{\@s{57.07} \.{\land} rankLock \.{=} 1}%
\@x{\@s{57.07} \.{\land} rankLock \.{'} \.{=} 0}%
 \@x{\@s{57.07} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{CS} ]}%
\@x{\@s{57.07} \.{\land} {\UNCHANGED} {\langle} freq ,\, words {\rangle}}%
\@pvspace{8.0pt}%
\@x{ CS ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{CS}}%
 \@x{\@s{57.07} \.{\land} words \.{'} \.{=} [ words {\EXCEPT} {\bang} [ self ]
 \.{=} words [ self ] \.{-} 1 ]}%
\@x{\@s{57.07} \.{\land} freq \.{'} \.{=} freq \.{+} 1}%
 \@x{\@s{57.07} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{l6} ]}%
\@x{\@s{57.07} \.{\land} {\UNCHANGED} rankLock}%
\@pvspace{8.0pt}%
\@x{ l6 ( self )\@s{5.38} \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{l6}}%
\@x{\@s{57.07} \.{\land} rankLock \.{'} \.{=} 1}%
 \@x{\@s{57.07} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{MainLoop} ]}%
\@x{\@s{57.07} \.{\land} {\UNCHANGED} {\langle} freq ,\, words {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ mainCounting ( self ) \.{\defeq} MainLoop ( self ) \.{\lor} l2 ( self )
 \.{\lor} CS ( self ) \.{\lor} l6 ( self )}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@pvspace{8.0pt}%
 \@x{ Next \.{\defeq} ( \E\, self \.{\in} 1 \.{\dotdot} NT \.{:} mainCounting
 ( self ) )}%
\@x{\@s{47.82} \.{\lor} Terminating}%
\@pvspace{8.0pt}%
 \@x{ Spec\@s{1.46} \.{\defeq} \.{\land} Init \.{\land} {\Box} [ Next ]_{
 vars}}%
 \@x{\@s{39.83} \.{\land} \A\, self \.{\in} 1 \.{\dotdot} NT \.{:} {\WF}_{
 vars} ( mainCounting ( self ) )}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Apr} 07 10:08:18 \ensuremath{CEST} 2021 by \ensuremath{davide
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Created \ensuremath{Tue}
 \ensuremath{Apr} 06 10:03:01 \ensuremath{CEST} 2021 by \ensuremath{davide
}%
\end{cpar}%
\end{lcom}%
\end{document}
